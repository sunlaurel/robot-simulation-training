...
def trainAndGraph(
    ...
    for epoch in range(num_epochs):
        ...
        if avg_loss < best_val_loss:
            ...
            save_path = f"./weights/best-weights-robot/(more-noise-velocities-vectors-20-past)best_weight{'_noise' if add_noise else ''}{'_rotate' if rotate else ''}{'_scale' if scale else ''}{'_offset' if offset else ''}{'(' + str(past_steps) + '-past)' if past_steps != 10 else ''}{'(0.1-sigma)' if add_noise else ''}.pth"
