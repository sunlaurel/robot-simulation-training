...
if __name__ == "__main__":
    ...
    for relative_past, target_pos, X_past_w, X_future_w, X_robot_w in data_loader:
        ...
        predicted_w = utils.data.ConvertRobotFrameToAbsolute(X_robot_w[:, -1] - X_robot_w[:, -2], predicted_r)
        target_pos_w = utils.data.ConvertRobotFrameToAbsolute(X_robot_w[:, -1] - X_robot_w[:, -2], target_pos_r)
